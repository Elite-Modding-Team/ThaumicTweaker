...
@Mixin(value = ItemVoidPickaxe.class, remap = false)
public class ItemVoidPickaxeMixin extends ItemPickaxe {
    protected ItemVoidPickaxeMixin(ToolMaterial materialIn) {
        super(materialIn);
    }
